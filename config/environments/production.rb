...
Rails.application.configure do
  ...
  # Log only to STDOUT by default (Since Rails 7.1, to be container frendly).
  # Setting RAILS_LOG_TO_STDOUT is no longer needed.
  # (in development and test already hardcoded to both log file and STDOUT).
