    ...
    module V1
      ...
      class PlansController < BaseApiController
        ...
        def create
          ...
          errs = Api::Belnet::V1::JsonValidationService.validation_errors(json: dmp)
          render_error(errors: errs, status: :bad_request) and return if errs.any?

          # Convert the JSON into a Plan and it's associations
          plan = Api::Belnet::V1::Deserialization::Plan.deserialize(json: dmp)
          if plan.present?
            ...
            errs = Api::Belnet::V1::ContextualErrorService.process_plan_errors(plan: plan)
            ...
            plan = Api::Belnet::V1::PersistenceService.safe_save(plan: plan)
        ...
        def index
          ...
          plans = Api::Belnet::V1::PlansPolicy::Scope.new(client, Plan).resolve
          if plans.present? && plans.any?
            @items = paginate_response(results: plans)
            @minimal = true
            render 'api/belnet/v1/plans/index', status: :ok
