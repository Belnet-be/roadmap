...
if plan.grant_id.present? && plan.grant.present?
  json.grant_id do
    json.partial! 'api/belnet/v1/identifiers/show', identifier: plan.grant
  end
end
...
if plan.identifier.present?
  json.dmproadmap_funding_opportunity_id do
    json.partial! 'api/belnet/v1/identifiers/show', identifier: Identifier.new(identifiable: plan,
...
json.dmproadmap_funded_affiliations [plan.org] do |funded_org|
  json.partial! 'api/belnet/v1/orgs/show', org: funded_org
end
